  ...
  return (
    <nav className={Styles.nav}>
      <a className={Styles.logolink} href="/">
        <div className={Styles.monogram}>QK</div>
      </a>
      ...
      <a className={Styles.social} href="https://twitter.com/qkleinfelter">
        <svg
      ...
      <a className={Styles.social} href="https://github.com/qkleinfelter">
        <svg
          className={Styles.socialicon}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 16 16"
      ...
      <a className={Styles.social} href="https://dev.to/qkleinfelter_98">
        <svg
          className={Styles.socialicon}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 40"
